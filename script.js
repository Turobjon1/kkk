...
alert( num1 + ' ni ' +  num2 + ' ga bolsa  qoldiq ' +  num1  % num2 + ' chiqadi ' )
...
let num11 = alert( 'random son' +  Math.round(Math.random()*10) )
...
alert( ' 12.510ni  '  +  Math.floor( num ) + ' ga aylantirdim'  )
...
let M = ' Mars IT school '

alert( ' Mars IT uzunligi '  +   M.length + ' chiqdi' )
...
console.log( harflar[18],harflar[19], harflar[16],  harflar[13], harflar[1], harflar[8], harflar[13], harflar[12] );
...
let pr1 = prompt( 'yoshingizni kiriting'  )


if ( pr1 => 18 ) {
    alert( 'siz balogat yoshiga yetgansiz' )
} else {
    alert( 'siz balogat yoshiga yetmagansiz' )
}


// 8-savol String metodlari vs Array metodlari splid
...
let err = ism.split(``).reverse().join(``)
